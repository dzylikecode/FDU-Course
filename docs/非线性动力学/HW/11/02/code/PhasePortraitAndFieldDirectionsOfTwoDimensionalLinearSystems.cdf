...
NotebookDataLength[     81982,       1690]
NotebookOptionsPosition[     54112,       1084]
NotebookOutlinePosition[     80551,       1651]
CellTagsIndexPosition[     80413,       1644]
WindowTitle->Phase Portrait and Field Directions of Two-Dimensional Linear \
Systems of ODEs
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a1$$ = 1, $CellContext`a2$$ = 
    2, $CellContext`b1$$ = 
    1, $CellContext`b2$$ = -2, $CellContext`pt1$$ = {-5.1, 
    4.8}, $CellContext`pt2$$ = {4.9, 
    5.1}, $CellContext`pt3$$ = {-4.9, -5}, $CellContext`pt4$$ = {4.9, -5.2}, 
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Style[
       "\!\(\*OverscriptBox[\(\(x\)\(\\ \)\), \(.\)]\)= \
\!\(\*SubscriptBox[\(a\), \(1\)]\)x + \!\(\*SubscriptBox[\(b\), \(1\)]\)y", 
        Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`a1$$], 1, "\!\(\*SubscriptBox[\(a\), \(1\)]\)"}, -10,
       10}, {{
       Hold[$CellContext`b1$$], 1, "\!\(\*SubscriptBox[\(b\), \(1\)]\)"}, -10,
       10}, {
      Hold[
       Style[
       "\!\(\*OverscriptBox[\(y\), \(.\)]\) = \!\(\*SubscriptBox[\(a\), \
\(2\)]\)x + \!\(\*SubscriptBox[\(b\), \(2\)]\)y", Bold]], 
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`a2$$], 2, "\!\(\*SubscriptBox[\(a\), \(2\)]\)"}, -10,
       10}, {{
       Hold[$CellContext`b2$$], -2, 
       "\!\(\*SubscriptBox[\(b\), \(2\)]\)"}, -10, 10}, {{
       Hold[$CellContext`pt1$$], {-5.1, 4.8}}, {-10, -10}, {10, 10}}, {{
       Hold[$CellContext`pt2$$], {4.9, 5.1}}, {-10, -10}, {10, 10}}, {{
       Hold[$CellContext`pt3$$], {-4.9, -5}}, {-10, -10}, {10, 10}}, {{
       Hold[$CellContext`pt4$$], {4.9, -5.2}}, {-10, -10}, {10, 10}}}, 
    Typeset`size$$ = {460., {153., 157.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`a1$2105$$ = 0, $CellContext`b1$2106$$ = 
    0, $CellContext`pt1$2107$$ = {0, 0}, $CellContext`pt2$2108$$ = {0, 
    0}, $CellContext`pt3$2109$$ = {0, 0}, $CellContext`pt4$2110$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a1$$ = 1, $CellContext`a2$$ = 
        ...
        1, $CellContext`b2$$ = -2, $CellContext`pt1$$ = {-5.1, 
         4.8}, $CellContext`pt2$$ = {4.9, 
         5.1}, $CellContext`pt3$$ = {-4.9, -5}, $CellContext`pt4$$ = {
         4.9, -5.2}}, "ControllerVariables" :> {
        Hold[$CellContext`a1$$, $CellContext`a1$2105$$, 0], 
        Hold[$CellContext`b1$$, $CellContext`b1$2106$$, 0], 
        Hold[$CellContext`pt1$$, $CellContext`pt1$2107$$, {0, 0}], 
        Hold[$CellContext`pt2$$, $CellContext`pt2$2108$$, {0, 0}], 
        Hold[$CellContext`pt3$$, $CellContext`pt3$2109$$, {0, 0}], 
        Hold[$CellContext`pt4$$, $CellContext`pt4$2110$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, 
      "Body" :> ($CellContext`m = {{$CellContext`a1$$, $CellContext`b1$$}, \
{$CellContext`a2$$, $CellContext`b2$$}}; Show[
         VectorPlot[
          
          Dot[$CellContext`m, {$CellContext`x, $CellContext`y}], \
{$CellContext`x, -10, 10}, {$CellContext`y, -10, 10}, 
          StreamPoints -> {{$CellContext`pt1$$, $CellContext`pt2$$, \
$CellContext`pt3$$, $CellContext`pt4$$}}, StreamStyle -> {Red, Thick}, 
          ImageSize -> {460, 310}], 
         Graphics[{Thick, Orange, 
           Map[Line[{(-100) #, 100 #}]& , 
            Select[
             Eigenvectors[$CellContext`m], And[Im[
                Part[#, 1]] == 0, Im[
                Part[#, 2]] == 0]& ]]}], PlotLabel -> Row[{
            Column[{
              Row[{
                Column[{
            ...
            Column[{"Eigenvalues:", 
              NumberForm[
               Chop[
                N[
                 Eigenvalues[$CellContext`m]]], {4, 2}]}], "  ", Null, 
            Column[{"Eigenvectors:", 
              NumberForm[
               Chop[
                N[
                 Part[
                  Eigenvectors[$CellContext`m], 1]]], {4, 2}], 
              NumberForm[
               Chop[
                N[
                 Part[
                  Eigenvectors[$CellContext`m], 2]]], {4, 2}]}]}]]), 
      "Specifications" :> {
        Style[
        "\!\(\*OverscriptBox[\(\(x\)\(\\ \)\), \(.\)]\)= \
\!\(\*SubscriptBox[\(a\), \(1\)]\)x + \!\(\*SubscriptBox[\(b\), \(1\)]\)y", 
         Bold], {{$CellContext`a1$$, 1, 
          "\!\(\*SubscriptBox[\(a\), \(1\)]\)"}, -10, 10, Appearance -> 
         "Labeled"}, {{$CellContext`b1$$, 1, 
          "\!\(\*SubscriptBox[\(b\), \(1\)]\)"}, -10, 10, Appearance -> 
         "Labeled"}, 
        Style[
        "\!\(\*OverscriptBox[\(y\), \(.\)]\) = \!\(\*SubscriptBox[\(a\), \
\(2\)]\)x + \!\(\*SubscriptBox[\(b\), \(2\)]\)y", 
         Bold], {{$CellContext`a2$$, 2, 
          "\!\(\*SubscriptBox[\(a\), \(2\)]\)"}, -10, 10, Appearance -> 
         "Labeled"}, {{$CellContext`b2$$, -2, 
          "\!\(\*SubscriptBox[\(b\), \(2\)]\)"}, -10, 10, Appearance -> 
         "Labeled"}, {{$CellContext`pt1$$, {-5.1, 4.8}}, {-10, -10}, {10, 10},
          ControlType -> 
         Locator}, {{$CellContext`pt2$$, {4.9, 5.1}}, {-10, -10}, {10, 10}, 
         ControlType -> 
         Locator}, {{$CellContext`pt3$$, {-4.9, -5}}, {-10, -10}, {10, 10}, 
         ControlType -> 
         Locator}, {{$CellContext`pt4$$, {4.9, -5.2}}, {-10, -10}, {10, 10}, 
         ControlType -> Locator}}, "Options" :> {TrackedSymbols -> True}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{511., {256., 261.}},
...
Cell[TextData[{
 "This Demonstration plots the phase portrait (or phase plane) and the vector \
field of directions around the fixed point ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"0", ",", "0"}], ")"}], TraditionalForm]], "InlineMath"],
 " of the two-dimensional linear system of first-order ordinary differential \
equations"
}], "ManipulateCaption",
 CellID->59671087],
   ...
   RowBox[{
    ...
    RowBox[{
     RowBox[{
      SubscriptBox["a", "2"], "x"}], "+", 
     RowBox[{
      SubscriptBox["b", "2"], "y"}]}]}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->6350499],

Cell["\<\
Drag the four locators to see the trajectories of four solutions of the \
system that go through them. The position of these points can be chosen by \
clicking on wherever you like inside the graphics. Thick orange lines \
parallel to the eigenvectors are shown if the eigenvalues of the system are \
real.\
\>", "ManipulateCaption",
 CellID->419222955],
...
Cell["\<\
For more information on phase portraits and types of fixed points for linear \
systems of ODEs, see, for example: \
\>", "DetailNotes",
 CellID->470596421],
...
Biology, Chemistry, and Engineering, ",
  FontSlant->"Italic"],
 "Cambridge: Westview Press, 2000."
}], "DetailNotes",
 CellID->6136209],

Cell[TextData[{
 "G. F. Simmons, ",
 StyleBox["Differential Equations with Applications and Historical Notes",
  FontSlant->"Italic"],
...
Cell[TextData[{
 ButtonBox["Characteristic Polynomia",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/CharacteristicPolynomial.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/CharacteristicPolynomial.html"],
 "l",
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
...
Cell[TextData[{
 ButtonBox["Fixed Point of a 2x2 Linear System of ODEs",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/FixedPointOfA2x2LinearSystemOfODEs/\
"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["Fixed Point",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/FixedPoint.html "], None},
  ButtonNote->"http://mathworld.wolfram.com/FixedPoint.html "],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Two-Dimensional Linear Systems",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TwoDimensionalLinearSystems/"], 
    None},
  ButtonNote->
...
PhasePortraitAndFieldDirectionsOfTwoDimensionalLinearSystems&version=0005"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
PhasePortraitAndFieldDirectionsOfTwoDimensionalLinearSystems/\
PhasePortraitAndFieldDirectionsOfTwoDimensionalLinearSystems-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Phase Portrait and Field Directions of Two-Dimensional Linear \
Systems of ODEs",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
PhasePortraitAndFieldDirectionsOfTwoDimensionalLinearSystems/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
PhasePortraitAndFieldDirectionsOfTwoDimensionalLinearSystems/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Santos Bravo Yuste",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Santos+Bravo+\
Yuste"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Santos+Bravo+Yuste"]
}], "Author",
...
CellTagsIndex->{
 "S5.42.1"->{
  Cell[35083, 595, 6376, 135, 70, "Output",
   CellTags->"S5.42.1",
   CellID->292594177]},
 "ControlSuggestions"->{
  Cell[42801, 779, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43062, 788, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[53290, 1059, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"S5.42.1", 80010, 1629},
 {"ControlSuggestions", 80127, 1633},
 {"Copyright", 80321, 1638}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[643, 22, 34328, 567, 70, "DemonstrationHeader"],
Cell[34974, 591, 106, 2, 70, "DemoTitle"],
Cell[35083, 595, 6376, 135, 70, "Output",
 CellTags->"S5.42.1",
 CellID->292594177],
Cell[41462, 732, 388, 10, 70, "ManipulateCaption",
 CellID->59671087],
Cell[41853, 744, 281, 10, 70, "ManipulateCaption",
 CellID->570645087],
Cell[42137, 756, 295, 12, 70, "ManipulateCaption",
 CellID->6350499],
Cell[42435, 770, 363, 7, 70, "ManipulateCaption",
 CellID->419222955],
Cell[42801, 779, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43062, 788, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43784, 808, 33, 0, 70, "DetailsSection"],
Cell[43820, 810, 165, 4, 70, "DetailNotes",
 CellID->470596421],
Cell[43988, 816, 246, 7, 70, "DetailNotes",
 CellID->6136209],
Cell[44237, 825, 207, 6, 70, "DetailNotes",
 CellID->309289021],
Cell[44447, 833, 43, 1, 70, "DetailNotes",
 CellID->864317037],
Cell[44493, 836, 44, 0, 70, "RelatedLinksSection"],
Cell[44540, 838, 670, 22, 70, "RelatedLinks",
 CellID->137441198],
Cell[45213, 862, 541, 16, 70, "RelatedLinks",
 CellID->69219798],
Cell[45757, 880, 624, 21, 70, "RelatedLinks",
 CellID->79665646],
Cell[46384, 903, 519, 16, 70, "RelatedLinks",
 CellID->148663990],
Cell[46906, 921, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51837, 1015, 45, 0, 70, "CitationSection"],
Cell[51885, 1017, 1060, 28, 70, "Citations"],
Cell[52948, 1047, 339, 10, 70, "Author"],
Cell[53290, 1059, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature KTUv2GB1HlQnavAXn7riQjM5 *)
